                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control text-white @if ($data->status == 'pending') bg-warning @elseif($data->status == 'approved') bg-success @elseif($data->status == 'rejected') bg-danger @endif"
                                        id="status" value="{{ $data->status }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <Label>Terima atau Tolak</Label>
                                    <div class="mb-3 d-flex">
                                        <form action="{{ route('admin.forum.rejected', $id) }}" method="post">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit" class="btn btn-icon btn-danger mr-2 mb-2"> <i
                                                    class="fa-solid fa-circle-xmark"></i></button>
                                        </form>
                                        <form action="{{ route('admin.forum.approved', $id) }}" method="post">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit" class="btn btn-icon btn-success mr-2 mb-2"> <i
